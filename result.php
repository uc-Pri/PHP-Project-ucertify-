        ...
        <div class="d-flex justify-content-center">
            ...
            <button class="btn btn-outline- me-2 px-2 px-md-4">
                <div>
                    ...
                    <span class="d-inline-block text-primary items"> 22</span>
                </div>
            ...
            <button class="btn btn-outline- me-2   px-2 px-md-4">
                <div>
                    ...
                    <span class="d-inline-block text-danger incorrect"> 3</span>
                </div>
                <span class="d-none d-md-inline-block ">
                    Incorrect
                </span>
            ...
            <button class="btn btn-outline- me-2 px-2 px-md-4">
                <div>
                    ...
                    <span class="d-inline-block text-warning unat">19</span>
                </div>
                <span class="d-none d-md-inline-block">
                    Unattempted
                </span>
            ...
            $.getJSON("file.json",
                function (data) {
                    ...
                    $.each(data, function (key, value) {
                        ...
                        // tb+='<tr>';
                        // tb+='<td>'+
                        tb += `<td class="text-center align-middle"><div class="d-flex justify-content-center"> <div class="circle corr_incorr" id="${key}0">A</div><div class="circle corr_incorr"id="${key}1">B</div> <div class="circle corr_incorr" id="${key}2"> C</div><div class="circle corr_incorr" id="${key}3">D</div> </div ></td>`;
                    ...
                    for (loop = 0; loop < 11; loop++) {
                        ...
                        output = sessionStorage.getItem("opt" + loop);
                        checkres = sessionStorage.getItem("result" + loop);
                        ...
                        $('.items').text(11);
                        $('.result').text(
                            (parseFloat(total / (11) * (100)).toFixed(2) + "%")
                        );

                        for (i = 0; i < 4; i++) {
                            if ((sessionStorage.getItem("opt" + loop)) == i) {
